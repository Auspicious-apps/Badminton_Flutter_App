          ...
          Row(children: [
            ...
            Obx(() => GestureDetector(
                  ...
                  child: Container(
                    ...
                    child: ClipRRect(
                      borderRadius: BorderRadius.circular(45),
                      child: (controller.ProfileData.value.data?.profilePic !=
                                  null &&
                          ...
                          ? Image.network(
                              controller.ProfileData.value.data!.profilePic!
                                      .startsWith('http')
                                  ? controller
                                          .ProfileData.value.data?.profilePic ??
                                      ""
    ...
    return WidgetGlobalMargin(
      child: RefreshIndicator(
        onRefresh: () async {
          ...
          await controller
              .getBookingList(); // Ensure this method exists in PlayController
        },
        child: SingleChildScrollView(
            child: Obx(
          () => Skeleton(
  ...
  Widget _buildFilters(BuildContext context) {
    ...
    return Row(
      ...
      children: [
        ...
        GestureDetector(
          onTap: () => controller.showCalendarBottomSheet(context),
          child: Image.asset(
            AppAssets.more,
            fit: BoxFit.contain,
            width: 25,
