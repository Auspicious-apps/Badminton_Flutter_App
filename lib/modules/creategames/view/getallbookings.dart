...
class Getallbookings extends GetView<GetAllBookingsController> {
  ...
  Widget build(BuildContext context) {
    ...
    final double spacing = screenWidth * 0.02; // 2% of screen width for spacing
    bool isMatchTimePassed(dynamic match) {
      try {
        ...
        if (currentHour > matchHour||currentHour==matchHour) {
          return true;
                  ...
                  children: [
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        controller.bookingList.value.data?.current?.length!=0 ? ListView.builder(
                          shrinkWrap: true,
                          physics: const NeverScrollableScrollPhysics(),
                          itemCount:
                          controller.bookingList.value.data?.current?.length ??
                              0,
                          itemBuilder: (context, index) {
                            final match =
                            controller.bookingList.value.data?.current?[index];
                            return GestureDetector(
                              onTap: ()=>{
                              Get.toNamed("/booking_detail",arguments: {"id":match?.sId,"isCancel":isMatchTimePassed(match?.bookingSlots??"")})
                              },
                              child: Container(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Obx(()=> controller.bookingList.value.data?.current?[index].score?.set1!=null? Column(
                                      mainAxisAlignment: MainAxisAlignment.start,
                                      crossAxisAlignment: CrossAxisAlignment.start,
                                      children: [
                                        Row(
                                              ...
                                              child: Row(
                                                ...
                                                children: [
                                                  SizedBox(
                                                    ...
                                                    child: Center(
                                                      child: Label(
                                                        txt: "${controller.bookingList.value.data?.current?[index].score?.set1?.team1??"0"}",
                                                        type: TextTypes.f_14_600,
                                                        forceColor: AppColors.smalltxt,
                                                      ),
                                                    ),
                                                ...
                                                SizedBox(
                                                  ...
                                                  child: Center(
                                                    child: Label(
                                                      txt: "${controller.bookingList.value.data?.current?[index].score?.set2?.team1??"0"}",
                                                      type: TextTypes.f_14_600,
                                                      forceColor: AppColors.smalltxt,
                                                    ),
                                                  ),
                                                  ...
                                                  SizedBox(
                                                    ...
                                                    child: Center(
                                                      child: Label(
                                                        txt: "${controller.bookingList.value.data?.current?[index].score?.set3?.team1??"0"}",
                                                        type: TextTypes.f_14_600,
                                                        forceColor: AppColors.smalltxt,
                                                      ),
                                                    ),
                                              ...
                                              child: Row(
                                                ...
                                                children: [
                                                  SizedBox(
                                                    ...
                                                    child: Center(
                                                      child: Label(
                                                        txt: "${controller.bookingList.value.data?.current?[index].score?.set1?.team2??"0"}",
                                                        type: TextTypes.f_14_600,
                                                        forceColor: AppColors.smalltxt,
                                                      ),
                                                    ),
                                                ...
                                                SizedBox(
                                                  ...
                                                  child: Center(
                                                    child: Label(
                                                      txt: "${controller.bookingList.value.data?.current?[index].score?.set2?.team2??"0"}",
                                                      type: TextTypes.f_14_600,
                                                      forceColor: AppColors.smalltxt,
                                                    ),
                                                  ),
                                                  ...
                                                  SizedBox(
                                                    ...
                                                    child: Center(
                                                      child: Label(
                                                        txt: "${controller.bookingList.value.data?.current?[index].score?.set3?.team2??"0"}",
                                                        type: TextTypes.f_14_600,
                                                        forceColor: AppColors.smalltxt,
                                                      ),
                                                    ),
                                    ...
                                    Align(
                                      ...
                                      child:  isMatchTimePassed(match?.bookingSlots??"")? GestureDetector(
                                        onTap: ()async {
                                      ...
                                      ):match?.askToJoin==true||match?.bookingType=="Cancelled"?SizedBox():GestureDetector(
                                        onTap: () async {
                        ...
                        controller.bookingList.value.data?.previous?.length!=0? ListView.builder(
                          shrinkWrap: true,
                          physics: const NeverScrollableScrollPhysics(),
                          itemCount:
                          controller.bookingList.value.data?.previous?.length ??
                              0,
                          itemBuilder: (context, index) {
                            final match =
                            controller.bookingList.value.data?.previous?[index];
                            return GestureDetector(
                              onTap: ()=>{
                                Get.toNamed("/booking_detail",arguments: {"id":match?.sId,"isCancel":false})
                              },
                              child: Container(
                                margin: const EdgeInsets.symmetric(vertical: 5),
                                padding: const EdgeInsets.all(10),
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Obx(()=> controller.bookingList.value.data?.previous?[index].score?.set1!=null? Column(
                                      mainAxisAlignment: MainAxisAlignment.start,
                                      crossAxisAlignment: CrossAxisAlignment.start,
                                      children: [
                                        Row(
                                            ...
                                            Row(
                                              ...
                                              children: [
                                                SizedBox(
                                                  ...
                                                  child: Center(
                                                    child: Label(
                                                      txt: "${controller.bookingList.value.data?.previous?[index].score?.set1?.team1??"0"}",
                                                      type: TextTypes.f_14_600,
                                                      forceColor: AppColors.smalltxt,
                                                    ),
                                                  ),
                                                ...
                                                SizedBox(
                                                  ...
                                                  child: Center(
                                                    child: Label(
                                                      txt: "${controller.bookingList.value.data?.previous?[index].score?.set2?.team1??"0"}",
                                                      type: TextTypes.f_14_600,
                                                      forceColor: AppColors.smalltxt,
                                                    ),
                                                  ),
                                                ...
                                                SizedBox(
                                                  ...
                                                  child: Center(
                                                    child: Label(
                                                      txt: "${controller.bookingList.value.data?.previous?[index].score?.set3?.team1??"0"}",
                                                      type: TextTypes.f_14_600,
                                                      forceColor: AppColors.smalltxt,
                                                    ),
                                                  ),
                                            ...
                                            Row(
                                              ...
                                              children: [
                                                SizedBox(
                                                  ...
                                                  child: Center(
                                                    child: Label(
                                                      txt: "${controller.bookingList.value.data?.previous?[index].score?.set1?.team2??"0"}",
                                                      type: TextTypes.f_14_600,
                                                      forceColor: AppColors.smalltxt,
                                                    ),
                                                  ),
                                                ...
                                                SizedBox(
                                                  ...
                                                  child: Center(
                                                    child: Label(
                                                      txt: "${controller.bookingList.value.data?.previous?[index].score?.set2?.team2??"0"}",
                                                      type: TextTypes.f_14_600,
                                                      forceColor: AppColors.smalltxt,
                                                    ),
                                                  ),
                                                ...
                                                SizedBox(
                                                  ...
                                                  child: Center(
                                                    child: Label(
                                                      txt: "${controller.bookingList.value.data?.previous?[index].score?.set3?.team2??"0"}",
                                                      type: TextTypes.f_14_600,
                                                      forceColor: AppColors.smalltxt,
                                                    ),
                                                  ),
