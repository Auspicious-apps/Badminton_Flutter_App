...
class PgConfirmpayment extends GetView<ConfirmPaymentController> {
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  const Divider(),
                                  padVertical(5),
                                  controller.image!=null||controller.image.isNotEmpty? Container(
                                    width: Get.width,
                                    height: Get.height*0.2,
                                    decoration: BoxDecoration(
                                      borderRadius: BorderRadius.circular(15),
                                      image: DecorationImage(
                                        image: NetworkImage("${imageBaseUrl}${controller.image??""}"),
                                        fit: BoxFit.cover,
                                      ),
                                    ),
                                    // child: Stack(
                                    ...
                                    children: [
                                      Row(
                                        children: [
                                          ...
                                          padHorizontal(5),
                                          Label(
                                            txt: DateFormat('yyyy-MM-dd').format(
                                ...
                                children: [
                                   Row(
                                    ...
                                    children: [
                                      ...
                                      GestureDetector(
                                          onTap: () async {
                                            await controller.equipment.showTooltip();
                                          },
                                          child: SuperTooltip(
                                              showBarrier: true,
                            ...
                            Container(
                              ...
                              GestureDetector(
                                ...
                                GestureDetector(
                                    onTap:(){
                                      if((int.parse(controller.Hourlyrate?.value ?? "0")<(controller.responseModel.value.data?.playCoins??0))||(int.parse(controller.Hourlyrate?.value ?? "0")==(controller.responseModel.value.data?.playCoins??0))||controller.PayBooking==true&&((int.parse(controller.Hourlyrate?.value ?? "0")/2)==(controller.responseModel.value.data?.playCoins??0))||controller.PayBooking==true&&((int.parse(controller.Hourlyrate?.value ?? "0")/2)<(controller.responseModel.value.data?.playCoins??0))){
                                        controller.PaymentMethod.value="Play Coins";
                                      }
                                      controller.PayBooking.value=true;
                                    },
                                    child: Row(
                                      mainAxisAlignment:
                                          MainAxisAlignment.spaceBetween,
                                      children: [
                                        Row(
                                          ...
                                          Obx(()=>  Container(
                                              ...
                                              child:controller.PayBooking.value==true? Container(
                                         ...
                                         Label(
                                          txt:"₹${(int.parse(controller.Hourlyrate?.value??"0")/2).toStringAsFixed(1)}",
                                          type: TextTypes.f_14_700,
                                        ),
                                      ],
                                    ),
                                  ...
                                  GestureDetector(
                                    onTap:(){
                                      controller.PayBooking.value=false;
                                    },
                                    child: Row(
                                      mainAxisAlignment:
                                      MainAxisAlignment.spaceBetween,
                                        ...
                                        Row(
                                          children: [
                                            Obx(()=>  Container(
                                              ...
                                              child:controller.PayBooking.value==false? Container(
                                                padding: const EdgeInsets.all(7),
                                                decoration: BoxDecoration(
                                                  color: AppColors.primaryColor,
                                                  borderRadius:
                                            ...
                                            padHorizontal(15),
                                            const Label(
                                              txt: "Pay Complete Amount",
                                              type: TextTypes.f_14_500,
                                            ),
                                          ],
                                        ),
                                         Label(
                                           txt:"₹${(controller.Hourlyrate?.value??"0")}",
                            ...
                            Container(
                              ...
                              Obx( ()=>  Label(
                                  ...
                                  GestureDetector(
                                    onTap:(){
                                      controller.PaymentMethod.value="Free";
                                    },
                                    child: Row(
                                      mainAxisAlignment:
                                      MainAxisAlignment.spaceBetween,
                                        ...
                                        Row(
                                          children: [
                                            Obx(()=>  Container(
                                              ...
                                              child:controller.PaymentMethod.value=="Free"? Container(
                                                padding: const EdgeInsets.all(7),
                                                decoration: BoxDecoration(
                                                  color: AppColors.primaryColor,
                                                  borderRadius:
                                  ...
                                  GestureDetector(
                                   ...
                                   Obx(() => (int.parse(controller.Hourlyrate?.value ?? "0")<(controller.responseModel.value.data?.playCoins??0))||(int.parse(controller.Hourlyrate?.value ?? "0")==(controller.responseModel.value.data?.playCoins??0))||controller.PayBooking==true&&((int.parse(controller.Hourlyrate?.value ?? "0")/2)==(controller.responseModel.value.data?.playCoins??0))||controller.PayBooking==true&&((int.parse(controller.Hourlyrate?.value ?? "0")/2)<(controller.responseModel.value.data?.playCoins??0))?SizedBox() :GestureDetector(
                                    onTap:(){
                                      controller.PaymentMethod.value="Both";
                                    },
                                    child: Row(
                      ...
                      // final playCoins = controller.responseModel.value.data?.playCoins ?? 0;
                        SizedBox(
                              ...
                              child:  Obx(()=>commonButton(
                                ...
                                forceColor:(int.parse(controller.Hourlyrate?.value ?? "0")<(controller.responseModel.value.data?.playCoins??0))||(int.parse(controller.Hourlyrate?.value ?? "0")==(controller.responseModel.value.data?.playCoins??0))||controller.PaymentMethod!="Play Coins"||controller.PaymentMethod=="Play Coins"&&controller.PayBooking==true&&((int.parse(controller.Hourlyrate?.value ?? "0")/2)==(controller.responseModel.value.data?.playCoins??0))||controller.PaymentMethod=="Play Coins"&&controller.PayBooking==true&&((int.parse(controller.Hourlyrate?.value ?? "0")/2)<(controller.responseModel.value.data?.playCoins??0))?AppColors.primaryColor :AppColors.grey.withOpacity(0.8),
                                txt:controller.PaymentMethod=="Free"?"${getPaymentText(
                                    controller)}":(int.parse(controller.Hourlyrate?.value ?? "0")<(controller.responseModel.value.data?.playCoins??0))||(int.parse(controller.Hourlyrate?.value ?? "0")==(controller.responseModel.value.data?.playCoins??0))||controller.PaymentMethod!="Play Coins"||controller.PaymentMethod=="Play Coins"&&controller.PayBooking==true&&((int.parse(controller.Hourlyrate?.value ?? "0")/2)==(controller.responseModel.value.data?.playCoins??0))||controller.PaymentMethod=="Play Coins"&&controller.PayBooking==true&&((int.parse(controller.Hourlyrate?.value ?? "0")/2)<(controller.responseModel.value.data?.playCoins??0))?"Pay ${getPaymentText(controller)}":"Insufficient Play Coins",

                                onPressed: () {
                                   Get.closeAllSnackbars();
                                  final homecontroller= Get.find<TabHomeController>();
                                   if(controller.PaymentMethod=="Free"&& ((homecontroller.responseModel.value.data?.loyaltyPoints?.freeGames??0)<controller.bookingSlots.length)){
                                     Get.snackbar("Error", "Not Enough Free Game");
                                     return ;
                                   }
                                   if((int.parse(controller.Hourlyrate?.value ?? "0")<(controller.responseModel.value.data?.playCoins??0))||(int.parse(controller.Hourlyrate?.value ?? "0")==(controller.responseModel.value.data?.playCoins??0)||controller.PaymentMethod!="Play Coins")){
                                     controller.isLoading.value=true;
                                     controller.BookingApi();
                                   }else if(controller.PayBooking.value==true&&(((int.parse(controller.Hourlyrate?.value ?? "0")/2)<(controller.responseModel.value.data?.playCoins??0))||((int.parse(controller.Hourlyrate?.value ?? "0")/2)==(controller.responseModel.value.data?.playCoins??0)||controller.PaymentMethod!="Play Coins"))){
                                     controller.isLoading.value=true;
                                     controller.BookingApi();
                                   }
